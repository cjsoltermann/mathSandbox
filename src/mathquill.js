...
(function () {
    ...
    var Fragment = /** @class */ (function () {
        function Fragment(withDir, oppDir, dir) {
            ...
            if (!withDir || !oppDir) {
                this.setEnds((_a = {}, _a[L] = 0, _a[R] = 0, _a));
                return;
            }
        ...
        Fragment.prototype.adopt = function (parent, leftward, rightward) {
            ...
            if (!rightEnd)
                return this;
            var ends = (_a = {}, _a[L] = parent.getEnd(L), _a[R] = parent.getEnd(R), _a);
            if (leftward) {
    ...
    var Cursor = /** @class */ (function (_super) {
        ...
        Cursor.prototype.getBoundingClientRectWithoutMargin = function () {
            ...
            var _a = getBoundingClientRect(frag.oneElement()), left = _a.left, right = _a.right;
    ...
    var ControllerBase = /** @class */ (function () {
        ...
        ControllerBase.prototype.handle = function (name, dir) {
            ...
            var handler = (_a = this.options.handlers) === null || _a === void 0 ? void 0 : _a.fns[name];
            if (handler) {
    ...
    function getInterface(v) {
        ...
        var EditableField = /** @class */ (function (_super) {
            ...
            EditableField.prototype.empty = function () {
                ...
                root.setEnds((_a = {}, _a[L] = 0, _a[R] = 0, _a));
                root.domFrag().empty();
    ...
    var saneKeyboardEvents = (function () {
        ...
        function getMQKeyStem(evt) {
            ...
            return (_a = KEY_TO_MQ_KEY_STEM[evt.key]) !== null && _a !== void 0 ? _a : evt.key;
        }
        ...
        Controller_latex.prototype.updateLatexMathEfficiently = function (latex, oldLatex) {
            ...
            if (oldMinusSign && !newMinusSign) {
                ...
                if (root.getEnd(L) === oldMinusNode) {
                    root.setEnds((_a = {}, _a[L] = oldCharNodes[0], _a[R] = root.getEnd(R), _a));
                }
                if (oldMinusNodeL)
    ...
    var Controller_scrollHoriz = /** @class */ (function (_super) {
        ...
        Controller_scrollHoriz.prototype.getScrollAnimationDuration = function () {
            var _a;
            return (_a = this.options.scrollAnimationDuration) !== null && _a !== void 0 ? _a : 100;
        };
    ...
    var TextBlock = /** @class */ (function (_super) {
        ...
        TextBlock.prototype.seek = function (clientX, cursor) {
            ...
            if (rects.length === 1) {
                var _a = rects[0], width = _a.width, left = _a.left;
    ...
    */
    ...
    for (var _i = 0, frakturLetters_1 = frakturLetters; _i < frakturLetters_1.length; _i++) {
        var _a = frakturLetters_1[_i], romanLetter = _a[0], frakturLetter = _a[1];
        LatexCmds[frakturLetter] = LatexCmds['frak' + romanLetter] = bindVanillaSymbol("\\mathfrak{".concat(romanLetter, "}"), "&".concat(romanLetter, "fr;"), 'fraktur ' + romanLetter);
    }
    LatexCmds.mathfrak = /** @class */ (function (_super) {
        ...
        class_4.prototype.parser = function () {
            ...
            return optWhitespace
                ...
                .map(function (c) {
                // instantiate the class for the matching char
                var cmd = LatexCmds["frak".concat(c)];
                if (isMQNodeClass(cmd)) {
                    return new cmd();
                }
                else {
    ...
    var Letter = /** @class */ (function (_super) {
        ...
        Letter.prototype.checkAutoCmds = function (cursor) {
            ...
            if (maxLength > 0) {
                ...
                // sequence of letters
                var str = (_a = letterSequenceEndingAtNode(this, maxLength)) !== null && _a !== void 0 ? _a : '';
        ...
        function Style(ctrlSeq, tagName, attrs, ariaLabel, opts) {
            var _this_1 = _super.call(this, ctrlSeq, new DOMView(1, function (blocks) {
                ...
                return h.block(tagName, attrs, blocks[0], {
                    beforeChild: (_a = opts === null || opts === void 0 ? void 0 : opts.beforeChild) === null || _a === void 0 ? void 0 : _a.call(opts),
    ...
    var Bracket = /** @class */ (function (_super) {
        ...
        function Bracket(side, open, close, ctrlSeq, end) {
            ...
            _this_1.side = side;
            _this_1.sides = (_a = {},
                _a[L] = { ch: open, ctrlSeq: ctrlSeq },
                _a[R] = { ch: close, ctrlSeq: end },
                _a);
            return _this_1;
        }
